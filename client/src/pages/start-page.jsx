      ...
      <section className="online__start">
        <div className="online__container">
          ...
          <div className="online__start-timer">
            {runingTimer && countTimer !== 0 && <Timer time={TRAINING_TIME} handler={handleCountTimer} />}
            {countTimer === 0 && <Result />}
